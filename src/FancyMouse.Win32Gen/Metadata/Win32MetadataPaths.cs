...
/// </remarks>
internal static class Win32MetadataPaths
{
    ...
    public static ImmutableArray<string> Get(AnalyzerConfigOptionsProvider options)
        => options.GlobalOptions.TryGetValue(Win32MetadataPaths.PropertyName, out var value) && !string.IsNullOrEmpty(value)
            ? value.Split(Win32MetadataPaths.Separator).ToImmutableArray()
