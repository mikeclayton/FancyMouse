...
internal static partial class User32
{
    ...
    {
        var returnValue = PInvoke.SetCursorPos(x, y);
        var lastError = Marshal.GetLastPInvokeError();

        // Returns nonzero if successful or zero otherwise.
        // To get extended error information, call GetLastError.
        //
        // Noe that SetCursorPos has been known to return zero (i.e. an error),
    ...
    {
        var returnValue = PInvoke.TrackPopupMenuEx(hMenu, uFlags, x, y, hwnd, lptpm);
        ...
        if (tpmFlags.HasFlag(TRACK_POPUP_MENU_FLAGS.TPM_RETURNCMD))
        {
            ...
            return returnValue.AlwaysSucceeds();
        }
