...
internal static class Win32ResultExtensions
{
    ...
    /// </summary>
    public static Win32Result<BOOL> SuccessIsZero(this BOOL value, [CallerMemberName] string methodName = "")
        => new(methodName, value, isSuccess: value == 0, useLastError: false, Marshal.GetLastPInvokeError());
    ...
    /// If the function fails, the return value is zero.
    /// </summary>
    public static Win32Result<ushort> SuccessIsNonZero(this ushort value, [CallerMemberName] string methodName = "")
        => new(methodName, value, isSuccess: value != 0, useLastError: false, Marshal.GetLastPInvokeError());
    ...
    /// If the function fails, the return value is zero.
    /// </summary>
    public static Win32Result<uint> SuccessIsNonZero(this uint value, [CallerMemberName] string methodName = "")
        => new(methodName, value, isSuccess: value != 0, useLastError: false, Marshal.GetLastPInvokeError());
    ...
    /// </summary>
    public static Win32Result<HMENU> SuccessIsNonNull(this HMENU value, [CallerMemberName] string methodName = "")
    ...
    /// If the function fails, the return value is null.
    /// </summary>
    public static Win32Result<HMONITOR> SuccessIsNonNull(this HMONITOR value, [CallerMemberName] string methodName = "")
        => new(methodName, value, isSuccess: !value.IsNull, useLastError: false, Marshal.GetLastPInvokeError());
    ...
    /// If the function fails, the return value is null.
    /// </summary>
    public static Win32Result<HWND> SuccessIsNotNull(this HWND value, [CallerMemberName] string methodName = "")
        => new(methodName, value, isSuccess: !value.IsNull, useLastError: false, Marshal.GetLastPInvokeError());
