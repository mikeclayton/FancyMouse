...
namespace Windows.Win32
{
	namespace Foundation
	{
		...
		internal unsafe readonly partial struct HMODULE
			: IEquatable<HMODULE>
		{
			internal readonly void* Value;

			internal HMODULE(void* value) => this.Value = value;

			internal HMODULE(IntPtr value):this(unchecked((void*)value))
			{
			}
			...
			public static implicit operator IntPtr(HMODULE value) => new IntPtr(value.Value);

			public static explicit operator HMODULE(IntPtr value) => new HMODULE((void*)value.ToPointer());

			public static explicit operator HMODULE(UIntPtr value) => new HMODULE((void*)value.ToPointer());
