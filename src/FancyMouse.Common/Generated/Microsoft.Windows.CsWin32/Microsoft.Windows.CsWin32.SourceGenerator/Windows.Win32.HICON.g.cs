...
namespace Windows.Win32
{
	namespace UI.WindowsAndMessaging
	{
		...
		internal unsafe readonly partial struct HICON
			: IEquatable<HICON>
		{
			internal readonly void* Value;

			internal HICON(void* value) => this.Value = value;

			internal HICON(IntPtr value):this(unchecked((void*)value))
			{
			}
			...
			public static implicit operator IntPtr(HICON value) => new IntPtr(value.Value);

			public static explicit operator HICON(IntPtr value) => new HICON((void*)value.ToPointer());

			public static explicit operator HICON(UIntPtr value) => new HICON((void*)value.ToPointer());
		}
	}
}
